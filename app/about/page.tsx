          ...
          <div className="mb-20">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed font-garamond">
                ...
                <p>
                  We provide Securities Industry Essentials (SIE) training resources and weekly office hours, operate a portfolio analytics program on BlackRock's Aladdin platform, and host our flagship "Wealth Management Week," where analysts present semester-long research to the broader Columbia community.
                </p>
                <p>
